...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      <div class="logo">
        <a class="text-decoration-none text-white"href="<?=base_url();?>"><?=NOMBRE_EMPRESA?></a>
      </div>
      <div class="login-box">
        <div id="divLoading">
        ...
        <form id="formResetPass" name="formResetPass" class="forget-form" action="">
          ...
          <div class="form-group">
            ...
            <input id="txtEmailReset" name="txtEmailReset" class="form-control" type="email" placeholder="abcd@outlook.com">
          </div>
          <div class="form-group btn-container">

<?php 
    class Roles extends Controllers{
        ...
        public function Roles(){
            ...
            $data['page_tag'] = "Roles | DigitalBlog";
			$data['page_title'] = "Roles | DigitalBlog";
            ...
            if($_SESSION['permisosMod']['r']){
                ...
                for ($i=0; $i < count($arrData); $i++) {
                    ...
                    if($_SESSION['permisosMod']['d']){
                        $btnDelRol = '<button class="btn btn-danger btn-sm btnDelRol" onClick="fntDelRol('.$arrData[$i]['idrol'].')" title="Eliminar"><i class="far fa-trash-alt"></i></button>';
                    }
        ...
        public function getSelectRoles(){
			...
			if(count($arrData) > 0 ){
				for ($i=0; $i < count($arrData); $i++) { 
					if($arrData[$i]['status'] == 1 ){
						$htmlOptions .= '<option value="'.$arrData[$i]['idrol'].'">'.$arrData[$i]['rolname'].'</option>';
					}
				}
			}
			echo $htmlOptions;
